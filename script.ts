...
const resumeDisplayElement = document.getElementById('resume-preview') as
HTMLDivElement;
...
const experience = (document.getElementById('work') as
HTMLTextAreaElement).value;
...
<h2><span contenteditable="true">${names}</span></h2>
...
(document.getElementById('work') as HTMLTextAreaElement).value
